...
@MyDocumentation(comment = "Comment for exercise",
                 author = "Programmer")
class AddnotationProcessor {


        private static List<String> SKIP_METHODS = Arrays.asList("equals", "toString", "hashCode", "annotationType");

        public static void main(String[] args) throws InvocationTargetException, IllegalAccessException {
            for (Annotation classAnnotation : AddnotationProcessor.class.getDeclaredAnnotations()) {
